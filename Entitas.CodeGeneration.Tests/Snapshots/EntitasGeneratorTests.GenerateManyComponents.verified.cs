...
public sealed partial class AudioContext : Entitas.Context<AudioEntity>
{
    public AudioContext()
        : base(
            AudioContextComponentRegistry.TotalComponents,
            0,
            new Entitas.ContextInfo(
                "Audio",
                AudioContextComponentRegistry.ComponentNames,
                AudioContextComponentRegistry.ComponentTypes
            ),
            (entity) =>
...
// AudioContextComponentRegistry.g.cs
public static class AudioContextComponentRegistry
{
    static int _total = AudioComponentsLookup.TotalComponents;
    static string[] _names = AudioComponentsLookup.componentNames;
    static System.Type[] _types = AudioComponentsLookup.componentTypes;
